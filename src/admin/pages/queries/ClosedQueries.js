...
export default function ClosedQueries() {
    const {closedQueries} = React.useContext(adminQueryContext)
    ...
    return (
        <>
            ...
            <div className="section">
                ...
                <button className="btn btn-secondary" onClick={()=>{history.push('/closedqueries')}}>Closed Queries</button>
            </div>
            <div className="section d-flex">
                {
                    closedQueries && closedQueries.map((item, index) => {
