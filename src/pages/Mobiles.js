...
export default function Mobiles() {
    let {sortedProducts, page, changePage, filters, roms, rams, allColors, batterys, chargingTypes, brands, updateFilters} = React.useContext(mobileContext)
    ...
    return (
        <div>
            ...
            <div className="filtration-and-products">
                <MobileFilters data = {{filters, roms, rams, allColors, batterys, chargingTypes, brands, updateFilters}}/>
